...
final List<Level> allLevels = [
  ...
  Level(
    ...
    logicalClues: [
      _m(
        'Журнал 603',
        '603: две цифры верны, одна стоит на своем месте.',
        important: true,
      ),
      _m('Журнал 918', '918: ни одной верной цифры.'),
      _l(
        'Ограничение',
        'Первая цифра четная, средняя цифра равна разнице крайних.',
      ),
    ],
    visualClues: [
    ...
    softHint: 'Если края 6 и 0, их разница подсказывает среднюю цифру.',
    solutionExplanation:
        '918 исключает 9,1,8. Подсказки оставляют 6 и 0 по краям, а разница 6-0 дает среднюю цифру 6, но повтор запрещен журналом; верная расстановка 630.',
  ),
  Level(
    id: 4,
  ...
  Level(
    ...
    logicalClues: [
      ...
      _m('Журнал 760', '760: одна цифра верна, но стоит не на своем месте.'),
    ...
    softHint: 'Середина не 4: журнал 760 указывает на 6 в другой позиции.',
    solutionExplanation:
        'В 345 точны 3 и 5. Из 760 верна 6, но не на первой позиции, поэтому она в середине: 365.',
  ),
  Level(
    id: 7,
    title: 'Северный сейф',
  ...
  Level(
    ...
    logicalClues: [
      ...
      _m('Журнал 671', '671: одна цифра верна, но стоит не на своем месте.'),
    ...
    availableTools: [SafeTool.fingerprintScanner, SafeTool.decryptor],
    softHint: 'Края из 293 остаются, а 7 меняет только середину.',
    solutionExplanation:
        '2 и 3 стоят на местах из 293. Из 671 входит 7, но не на первой позиции, значит код 273.',
  ),
  Level(
    id: 11,
  ...
  Level(
    ...
    logicalClues: [
      ...
      _m('Журнал 8800', '8800: одна цифра верна, но стоит не на своем месте.'),
      _l('Ограничение', 'Код содержит ровно две четные цифры.'),
    ],
    visualClues: [
    ...
    solutionExplanation:
        '4,1,6 стоят на местах. Журнал 8800 показывает, что 8 входит, но не на первой позиции, поэтому код 4816.',
  ),
  Level(
    id: 13,
    title: 'Черная бирка',
    ...
    logicalClues: [
      ...
      _m('Журнал 7810', '7810: одна цифра верна, но стоит не на своем месте.'),
      _l(
        'Ограничение',
    ...
    softHint: 'Первые три позиции уже надежны; ищи последнюю по журналу 7810.',
    solutionExplanation:
        '2,0 и 5 фиксируются первой записью. Из 7810 подходит только 7, и она становится последней цифрой.',
  ),
  Level(
    id: 14,
  ...
  Level(
    ...
    logicalClues: [
      ...
      _l('Ограничение', 'Код содержит три четные цифры и один ноль.'),
    ],
    visualClues: [
  ...
  Level(
    ...
    logicalClues: [
      ...
      _m('Журнал 9017', '9017: одна цифра верна и стоит на своем месте.'),
    ...
    softHint: 'Последняя позиция подтверждается второй записью.',
    solutionExplanation:
        '5,8,2 стоят верно. В 9017 точной является 9 на первой позиции записи, но в коде она занимает последнюю после исключения 0.',
  ),
  Level(
    id: 18,
    title: 'Серый планшет',
  ...
  Level(
    ...
    logicalClues: [
      ...
      _m('Журнал 2419', '2419: одна цифра верна и стоит на своем месте.'),
    ...
    softHint: 'Последняя цифра из второй записи уже стоит в правильном окне.',
    solutionExplanation:
        'Первые три цифры 8,7,6 верны. В 2419 точной является 2 на первой позиции записи, но визуальная улика закрепляет ее в финальном окне.',
  ),
  Level(
    id: 20,
    title: 'Сейф с меткой',
  ...
  Level(
    ...
    logicalClues: [
      ...
      _m(
        'Журнал 76028',
        '76028: две цифры верны, но стоят не на своих местах.',
      ),
    ...
    solutionExplanation:
        'Первые четыре позиции 9,3,0,4 закреплены. Из 76028 подходит 7 и она занимает последний слот.',
  ),
  Level(
    id: 23,
  ...
  Level(
    ...
    logicalClues: [
      ...
      _l('Ограничение', 'В коде три четные цифры и один ноль.'),
    ],
    visualClues: [
  ...
  Level(
    ...
    logicalClues: [
      ...
      _l('Ограничение', 'Код содержит ровно три нечетные цифры.'),
    ],
    visualClues: [
